...
function up() {car1_y=car1_y-10;
upload_background();
upload_car1()};
function down() {car1_y=car1_y+10;
    upload_background();
    upload_car1()};
    function left() {car1_x=car1_x-10;
        upload_background();
        upload_car1()};
        function right() {car1_x=car1_x+10;
            upload_background();
            upload_car1()};
            function up() {car2_y=car2_y-10;
                upload_background();
                upload_car2()};
                function down() {car2_y=car2_y+10;
                    upload_background();
                    upload_car2()};
                    function left() {car2_x=car2_x-10;
                        upload_background();
                        upload_car2()};
                        function right() {car2_x=car2_x+10;
                            upload_background();
                            upload_car2()};